...
function Invoices() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-semibold text-[#363f49]">My Invoices</h1>
        <p className="text-gray-600 mt-1">Admin billing view for your account.</p>
      ...
      {rows.length === 0 ? (
        <div className="p-6 bg-white rounded-lg shadow-sm text-gray-600">No invoices found.</div>
      ) : (
