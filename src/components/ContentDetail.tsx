...
import { ArrowLeft, Clock, Tag, User, Calendar, Video, FileText, BookOpen, Download, ThumbsUp, ThumbsDown } from 'lucide-react';
...
export const ContentDetail: React.FC = () => {
  ...
  const handleFeedbackSubmit = async (e: React.FormEvent) => {
    ...
    if (!singleContent || wasHelpful === null) {
