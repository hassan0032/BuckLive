...
import { Plus, Edit, Search, Mail, User as UserIcon, Calendar, Activity } from 'lucide-react';
...
export const UserManagement: React.FC<UserManagementProps> = ({ communityId, communityName }) => {
  const { users, loading, createUser, updateUser } = useCommunityUsers(communityId);
